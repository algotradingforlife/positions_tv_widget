...
async function main() {
  ...
  if (process.env.NODE_ENV === 'production') {
    body = await awaitElement('[class^="listContainer"]');
    body.lastChild.lastChild.style.display = 'none';
  }
  ...
  body.appendChild(positionsContainer);
  ReactDOM.render(<App />, positionsContainer);
}
